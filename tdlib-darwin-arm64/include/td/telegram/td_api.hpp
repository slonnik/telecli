...
bool downcast_call(Object &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case stickerSets::ID:
      ...
      return true;
    case stickerTypeStatic::ID:
      func(static_cast<stickerTypeStatic &>(obj));
      return true;
    case stickerTypeAnimated::ID:
      func(static_cast<stickerTypeAnimated &>(obj));
      return true;
    case stickerTypeVideo::ID:
      func(static_cast<stickerTypeVideo &>(obj));
      return true;
    ...
    case updateWebAppMessageSent::ID:
      ...
      return true;
    case updateReactions::ID:
      func(static_cast<updateReactions &>(obj));
      return true;
...
bool downcast_call(Function &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case getActiveSessions::ID:
      ...
      return true;
    case getAllAnimatedEmojis::ID:
      func(static_cast<getAllAnimatedEmojis &>(obj));
      return true;
    ...
    case setMenuButton::ID:
      ...
      return true;
    case setMessageReaction::ID:
      func(static_cast<setMessageReaction &>(obj));
      return true;
    case setName::ID:
